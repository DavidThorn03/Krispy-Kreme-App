...
export default function Product() {
    ...
    useEffect(() => {
        fetch('https://krispy-kreme-app-beige.vercel.app/api/getWeather')
            .then((res) => res.json())
            .then((weather) => {
                setWeatherData(weather)
            })
        fetch('https://krispy-kreme-app-beige.vercel.app/api/getProducts')
            .then((res) => res.json())
            .then((data) => {
                setData(data)
            })
    ...
    const addToCart = (product, price) => {
        ...
        runDBCallAsync(`https://krispy-kreme-app-beige.vercel.app/api/addToCart?user=${user.email}&product=${product}&price=${price}`)
    }; // end handle submit
